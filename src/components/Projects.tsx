...
export default function Projects() {
  ...
  const categories = [(import.meta as any).env?.VITE_DUMMY_VAR ? "" : "all", "ai-ml", "dsa-java", "web-dev"];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 bg-blue-50 border border-blue-100 rounded-full text-blue-700 text-xs font-mono font-semibold">
            ...
            03 . REPOSITORY EXHIBITION
          </div>
          <h2 className="text-3xl sm:text-4xl font-extrabold tracking-tight text-slate-900">
            Selected Engineered Systems
          </h2>
          <p className="text-sm sm:text-base text-slate-500 max-w-2xl mx-auto">
            A hand-picked selection of production-minded frameworks, algorithmic structures, 
            and retrieval agents representing practical systems architecture.
          </p>
        </div>
        ...
        {filteredProjects.length === 0 && (
          <div className="text-center py-20 border border-dashed border-slate-200 rounded-2xl max-w-md mx-auto">
            ...
            <p className="text-xs text-slate-400 mt-1">Try searching for other tech badges like "PyTorch" or "LangChain"</p>
          </div>
        )}
            ...
            {filteredProjects.map((project: Project) => (
              ...
              >
                ...
                <div className="p-6 pt-0 border-t border-slate-50 mt-4 flex items-center justify-between gap-2 bg-slate-50/50">
                  <button
                    id={`project-${project.id}-modal-trigger`}
              ...
              >
                ...
                <div className="relative h-48 bg-slate-100">
                  ...
                  <button
                    ...
                    className="absolute top-4 right-4 p-2 bg-slate-950/80 hover:bg-slate-950 border border-white/10 rounded-full text-white cursor-pointer transition-colors shadow-md"
                  ...
                  <div className="absolute bottom-4 left-6 right-6">
                    ...
                    <h3 className="text-lg md:text-xl font-extrabold text-white mt-1.5 leading-tight text-center sm:text-left">
                ...
                <div className="p-6 space-y-6 overflow-y-auto max-h-[350px]">
                  <div className="space-y-2">
                    <h5 className="text-xs font-mono font-bold text-slate-400 uppercase tracking-widest flex items-center gap-1">
